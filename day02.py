...
def find_sum_power(data):
    """
    >>> find_sum_power(["Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
    ... "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue",
    ... "Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red",
    ... "Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red",
    ...
    for item in edited_data:
        ...
        for game_throw in game[1]:
            ...
            for single_cubes_throw in game_throw:
                if str(single_cubes_throw).find("red") != -1 and max_throw_red < int(''.join(filter(str.isdigit, single_cubes_throw))):
                    max_throw_red = int(''.join(filter(str.isdigit, single_cubes_throw)))
                elif str(single_cubes_throw).find("green") != -1 and max_throw_green < int(''.join(filter(str.isdigit, single_cubes_throw))):
                    max_throw_green = int(''.join(filter(str.isdigit, single_cubes_throw)))
                elif str(single_cubes_throw).find("blue") != -1 and max_throw_blue < int(''.join(filter(str.isdigit, single_cubes_throw))):
                    max_throw_blue = int(''.join(filter(str.isdigit, single_cubes_throw)))

        count += max_throw_red * max_throw_green * max_throw_blue
...
if __name__ == "__main__":
    ...
    print("Sum of power of minimum number of cubes: " + str(find_sum_power(data_input)))
